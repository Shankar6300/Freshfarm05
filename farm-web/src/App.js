...
import AdminDeliveryPartners from './Pages/AdminManagement/AdminDeliveryPartners';
...
import OrderConfirmationPage from './User/OrderConfirmationPage';
        ...
        <TokenProvider>
          <BrowserRouter>
            ...
            <Route path="/login" element={<Login setAuthenticated={setAuthenticated} />} />
              ...
              <Route path="/farmer_riders/:farmerId" element={<FarmerRiders /> } />
              <Route path="/admin_management/:adminId" element={<AdminManagementInterface /> } />
              <Route path="/admin_delivery_partners/:adminId" element={<AdminDeliveryPartners /> } />
