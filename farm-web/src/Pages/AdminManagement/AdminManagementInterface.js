...
const AdminManagementInterface = () => {
  ...
  const fetchAdminsData = async () => {
    try {
      const response = await axios.get('https://d2pskbh3g9o3pk.cloudfront.net/admins');
  ...
  const handleSaveEdit = async () => {
    try {
      await axios.put(`https://d2pskbh3g9o3pk.cloudfront.net/admins/${editedAdmin.admin_id}`, editedAdmin);
      setEditedAdmin(null);
  ...
  const handleDelete = async () => {
    try {
      await axios.delete(`https://d2pskbh3g9o3pk.cloudfront.net/admins/${deleteAdminId}`);
      setDeleteMessage('');
