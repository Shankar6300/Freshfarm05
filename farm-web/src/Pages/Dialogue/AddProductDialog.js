...
const AddProductDialog = ({ onSave, onClose }) => {
  ...
  const handleSaveClick = async () => {
    try {
      ...
      formData.append('name_hi', newProduct.name_hi || '');
      formData.append('name_te', newProduct.name_te || '');
  ...
  return (
    <div style={{ position: 'fixed', top: 0, left: 0, width: '100%', height: '100%', backgroundColor: 'rgba(0, 0, 0, 0.5)', display: 'flex', justifyContent: 'center', alignItems: 'center' }}>
      <div style={{ backgroundColor: '#fff', padding: '40px 30px 30px 50px', borderRadius: '8px', boxShadow: '0 4px 8px rgba(0, 0, 0, 0.2)', maxWidth: '450px', width: '100%', textAlign: 'center' }}>
        <h2 style={{ color: '#333', borderBottom: '2px solid #ccc', paddingBottom: '10px', margin: '10px 0 30px 0px' }}>{t('addProduct')}</h2>
        <div style={{ textAlign: 'left', marginBottom: '20px' }}>
          <label style={{ fontWeight: 'bold', marginBottom: '5px', display: 'block' }}>{t('nameLabel')}:</label>
          ...
          <label style={{ fontWeight: 'bold', marginBottom: '5px', display: 'block' }}>{t('nameHindiLabel')}:</label>
          <input type="text" name="name_hi" value={newProduct.name_hi} onChange={handleInputChange} style={{ width: '90%', padding: '10px', border: '1px solid #ccc', borderRadius: '12px', marginBottom: '15px', fontSize: '14px' }} />
          <label style={{ fontWeight: 'bold', marginBottom: '5px', display: 'block' }}>{t('nameTeluguLabel')}:</label>
          <input type="text" name="name_te" value={newProduct.name_te} onChange={handleInputChange} style={{ width: '90%', padding: '10px', border: '1px solid #ccc', borderRadius: '12px', marginBottom: '15px', fontSize: '14px' }} />
          <label style={{ fontWeight: 'bold', marginBottom: '5px', display: 'block' }}>{t('description')}:</label>
          ...
          <label style={{ fontWeight: 'bold', marginBottom: '5px', display: 'block' }}>{t('categoryLabel')}:</label>
          ...
          <label style={{ fontWeight: 'bold', marginBottom: '5px', display: 'block' }}>{t('priceLabel')}:</label>
          ...
          <label style={{ fontWeight: 'bold', marginBottom: '5px', display: 'block' }}>{t('quantityLabel')}:</label>
          ...
          <label style={{ fontWeight: 'bold', marginBottom: '5px', display: 'block' }}>{t('imageLabel')}:</label>
        ...
        <div>
          <button onClick={handleSaveClick} style={{ padding: '12px 24px', border: 'none', borderRadius: '5px', backgroundColor: '#4CAF50', color: 'white', cursor: 'pointer', marginRight: '10px', fontSize: '16px' }}>{t('save')}</button>
